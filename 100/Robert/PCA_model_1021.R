...
DB_parser_origin<- function(raw_g1e0915,birth_data,folderpath, parameter){
  ...
  # all_dataset0912 저장
  write.csv(all_dataset0912, 'working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_.csv')
  write.csv(all_dataset091220, 'working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_20.csv')
  write.csv(all_dataset091230, 'working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_30.csv')
  write.csv(all_dataset091240, 'working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_40.csv')
  write.csv(all_dataset091250, 'working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_50.csv')
  write.csv(all_dataset091260, 'working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_60.csv')
  write.csv(dataset_for_cox,'working/result_pca_r/dataset_for_cox.csv' )
  print('')
  print('### all condition group saved ###')
  print('')
...
PCA_model_R_origin<-function(data_12, age_label, gender,selected_components){
  ...
  #### 6. BA-CA fit
  filename_pc <- paste0('working/result_pca_r/mediage_demo_dataset_NHIS_unit_all0912_',age_label,'.csv')
...
#DrinkSmoke
selected_components <- c('SEX','age','G1E_BMI','G1E_WSTC','G1E_BP_SYS','G1E_FBS','G1E_TOT_CHOL','G1E_TG','G1E_HDL','G1E_HGB','G1E_SGPT','eGFR','DRK','DRK2', 'PA','PA2','SMK')
# 300K original
death_and_dm_origin(dataset_for_cox=dataset_for_cox,age_label=age_label, gender=gender,selected_components=selected_components)
...
all_parameter <-c('G1E_BMI','G1E_WGHT','G1E_WSTC','G1E_BP_SYS','G1E_BP_DIA','G1E_FBS','G1E_TOT_CHOL','G1E_TG',
                  'G1E_HDL','G1E_LDL','G1E_HGB', 'G1E_URN_PROT','G1E_CRTN','G1E_SGOT','G1E_SGPT','G1E_GGT','eGFR','SMK','DRK','PA','DRK2','PA2')
